CREATE DEFINER=`root`@`localhost` PROCEDURE `get_staff_trained`(criteria VARCHAR(45), analytic_value VARCHAR(45), survey_type VARCHAR(45),survey_category VARCHAR(45), guidefor VARCHAR(45))
BEGIN
