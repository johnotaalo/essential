function startAnalytics(base_url, county, survey, survey_category) {
    ...
    if (survey_category != '') {
        ...
        //getReportingData(base_url, survey, survey_category, '#reportingleft','reportingleft');
        //getReportingData(base_url, survey, survey_category, '#reportingright','reportingright');
    }
    // if (county !== '') {
