...
class UserTypes
{
     ...
     * @var integer
     *
     * @Column(name="ut_id", type="integer", nullable=false)
     * @Id
     ...
     * @var string
     *
     * @Column(name="ut_name", type="string", length=45, nullable=true)
     */
    private $utName;
     ...
     * @var string
     *
     * @Column(name="ut_level", type="string", length=45, nullable=true)
     */
    private $utLevel;
     ...
     * @var string
     *
     * @Column(name="ut_roles", type="string", length=45, nullable=true)
     */
    private $utRoles;
