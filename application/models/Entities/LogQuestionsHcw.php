...
class LogQuestionsHcw
{
     ...
     * @var string
     *
     * @Column(name="lq_reason", type="string", length=200, nullable=true)
     */
    private $lqReason;
     ...
     * @var string
     *
     * @Column(name="lq_specified_or_follow_up", type="string", length=255, nullable=true)
     */
     ...
     * @var \DateTime
     *
     * @Column(name="lq_created", type="datetime", nullable=true)
     */
    private $lqCreated;
     ...
     * @var integer
     *
     * @Column(name="lq_response_count", type="integer", nullable=true)
     */
     ...
     * @var string
     *
     * @Column(name="question_code", type="string", length=8, nullable=true)
     */
     ...
     * @var string
     *
     * @Column(name="fac_mfl", type="string", length=11, nullable=true)
     */
    private $facMfl;
