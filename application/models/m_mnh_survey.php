...
class M_MNH_Survey extends MY_Model
{
    ...
    // var $commodity, $isFacility, $ortAspectsList, $mchGuidelineAvailabilityList, $commodityList, $trainingGuidelinesList, $equipmentList, $suppliesList, $indicatorList, $treatmentList, $healthServicesList, $treatmentcommodityList;
