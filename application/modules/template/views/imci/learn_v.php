				...
				<div class="col-md-3">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<?php echo anchor('learn', 'Change', array('class'=>'pull-right')); ?>
						</div>
					</div>
							...
							<li class="list-group-item lead">
								...
								<div class="btn-group btn-xs pull-right">
									...
									<ul class="dropdown-menu" role="menu">
										<li><?php echo anchor('learn/content/read', 'Read'); ?></li>
										<li><?php echo anchor('learn/content/see', 'See'); ?></li>
										<li class="divider"></li>
										<li><?php echo anchor('test/practice/1', 'Practice Test'); ?></li>
									</ul>
								</div>
